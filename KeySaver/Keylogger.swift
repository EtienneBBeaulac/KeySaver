...
//        keylogs = bundlePathURL.appendingPathComponent("Data").appendingPathComponent("Logs")
        ...
        keyboards = keyboards.adding(CreateDeviceMatchingDictionary(inUsagePage: kHIDPage_GenericDesktop, inUsage: kHIDUsage_GD_Keyboard)) as NSArray
        keyboards = keyboards.adding(CreateDeviceMatchingDictionary(inUsagePage: kHIDPage_GenericDesktop, inUsage: kHIDUsage_GD_Keypad)) as NSArray
